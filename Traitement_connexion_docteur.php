...
$sql = "SELECT * FROM Docteurs WHERE identifiant='$identifiant'  AND Mot_de_passe='$Mot_de_passe'";
...
if ($resultat->num_rows > 0) {
    ...
    echo "Accès autorisé.";
    header("Location: tableau_bord_docteur.php");
    exit();
} else {
    // Utilisateur non trouvé, accès refusé
    echo "<span>Accès refusé! Identifiant ou mot de passe incorrect</span>";
}
